...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-27 11:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/88b0fb4f-fa6f-45df-be05-52f4d0234b32.git
$ cd 88b0fb4f-fa6f-45df-be05-52f4d0234b32
```
